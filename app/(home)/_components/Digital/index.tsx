                ...
                <div className='grid grid-cols-1 lg:grid-cols-2 my-16'>
                    ...
                    <div className="pt-24 lg:pl-24">
                        ...
                        <h4 className="text-4xl sm:text-6xl font-bold text-white mb-8 leading-snug text-center lg:text-start">
                            We train the pilots <br /> who fly the world <br /> with skill and precision.
                        </h4>
                    ...
                    {/* COLUMN-2 */}
                    <div>
                        <div className="lg:absolute right-20 -bottom-[10rem]">
                            <Image
                                src="/images/digital/doodle.png" // replace with actual pilot-themed image
