...
const postData: DataType[] = [
    {
        heading: '100% Cadet Selection – IndiGo Program 2024',
        imgSrc: '/images/featured/1.png',
    },
    {
        heading: 'Global CPL Training – South Africa, Canada, Europe',
        imgSrc: '/images/featured/2.png',
    },
    {
        heading: 'Air India Cadet Pilot Achievers – Class of 2023',
        imgSrc: '/images/featured/3.png',
    },
...
export default class FeaturedHighlights extends Component {
    render() {
        const settings = {
            dots: false,
            infinite: true,
