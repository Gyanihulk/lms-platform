...
console.log(course)
  return (
    ...
    <h5 className="mb-2 text-3xl font-bold text-gray-900 dark:text-white">{course.title}</h5>
    <p className="mb-5 text-base text-gray-500 sm:text-lg dark:text-gray-400">{course.description}</p>
    <span className="bg-blue-100 text-blue-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded dark:bg-gray-700 dark:text-blue-400 border border-blue-400">Default</span>
